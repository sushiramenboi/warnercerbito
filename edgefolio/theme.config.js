...
export const social = [
  {
    name: 'Twitter',
    url: 'https://twitter.com/Warnerrrrrrr',
    Icon: IoLogoTwitter,
  },
  {
    name: 'Instagram',
    url: 'https://www.instagram.com/warnercerbito/',
    Icon: IoLogoInstagram,
  },
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/warner-cerbito-b509a0214/',
    Icon: IoLogoLinkedin,
  },
]
...
export const siteMetaData = {
  ...
  authorName: 'Warner Cerbito',
  siteName: 'Warner Cerbito',
  defaultTitle: 'Warner Cerbito',
  titleTemplate: 'Warner Cerbito | %s',
  description: 'A short description goes here.',
  email: 'cerbitowarner2@gmail.com',
  locale: 'en_US',
  twitter: {
    handle: '@handle',
    site: '@site',
